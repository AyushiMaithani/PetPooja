...
import { getInitials,formatDateAndTime } from "../../utils/index";

const OrderCard = ({key,order}) => {
console.log(order.table.tableNo);
  return (
    <div 
    key={key}
    className="w-[450px] bg-[#262626] p-4 rounded-lg mb-4">
      ...
      <div className="flex items-center justify-between w-[100%]">
        <div className="flex flex-col items-start gap-1">
          ...
          <p className="text-[#ababab] text-sm">
            Table
             <FaLongArrowAltRight className="text-[#ababab] mx-1 mb-0.5 inline" /> 
            {order.table.tableNo}
            </p>
        </div>
